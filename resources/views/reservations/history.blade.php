        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Historique des réservations</h1>
                ...
                @if($reservations->isEmpty())
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Aucun historique</h3>
                        <p class="text-gray-500 dark:text-gray-400 mb-4">Vous n'avez pas encore d'historique de réservation.</p>
                    </div>
                @else
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center bg-primary-100 dark:bg-primary-900 text-primary-600 dark:text-primary-300 rounded-full">
